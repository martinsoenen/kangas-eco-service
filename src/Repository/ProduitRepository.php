...
class ProduitRepository extends ServiceEntityRepository
{
    ...
    public function findCategories(int $id) {
        ...
        $sql ='
            SELECT p.id, p.sous_categorie_produit_id, p.utilisateur_admin_id, p.nom_produit, p.prix_unitaire_ht, p.taux_tva, p.presentation, p.description_detaillee, cp.nom, scp.nom
            FROM produit p
